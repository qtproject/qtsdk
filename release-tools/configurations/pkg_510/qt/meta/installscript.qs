...
changeLicenseLabels = function()
{
    ...
    page.AcceptLicenseLabel.setText("I h<u>a</u>ve read and agree to the following terms contained in the license agreements accompanying the Qt 5.1.0 installer and additional items. I agree that my use of the Qt 5.1.0 installer is governed by the terms and conditions contained in these license agreements.");

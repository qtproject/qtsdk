...
addDynamicDependencies = function(page)
{
    ...
    dynamicDependencies.push("qt.501.gcc_64.essentials");
    dynamicDependencies.push("qt.501.gcc_64.addons");
    dynamicDependencies.push("qt.501.gcc.essentials");
    dynamicDependencies.push("qt.501.gcc.addons");
    dynamicDependencies.push("qt.501.clang_64.essentials");
    dynamicDependencies.push("qt.501.clang_64.addons");
    dynamicDependencies.push("qt.501.win32_mingw.addons");
    dynamicDependencies.push("qt.501.win32_mingw.essentials");
    dynamicDependencies.push("qt.501.win32_msvc2010.essentials");
    dynamicDependencies.push("qt.501.win32_msvc2010.addons");
    dynamicDependencies.push("qt.501.win32_msvc2010_64.essentials");
    dynamicDependencies.push("qt.501.win32_msvc2010_64.addons");
...
Component.prototype.createOperations = function()
{
    ...
    if (installer.value("os") == "win") {
        try {
            // patch Qt binaries
            if (installer.value("qt.501.win32_mingw.essentials_qtpath"))
                component.addOperation("QtPatch", "windows", installer.value("qt.501.win32_mingw.essentials_qtpath"));
            ...
            if (installer.value("qt.501.win32_msvc2010_64.essentials_qtpath"))
                component.addOperation("QtPatch", "windows", installer.value("qt.501.win32_msvc2010_64.essentials_qtpath"));
        } catch( e ) {
            print( e );
        }
    }

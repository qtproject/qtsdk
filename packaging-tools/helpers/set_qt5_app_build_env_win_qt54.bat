...
if %errorlevel%==0 (
set "PATH=c:\work\build\qtsdk\gnuwin32\bin;C:\Utils\icu32_53_1_msvc2010\bin;c:\Utils\icu32_53_1_msvc2010\lib;%PATH_MSVC2010%;%PATH%"
set "LIB=c:\Utils\icu32_53_1_msvc2010\lib;%LIB_MSVC2010%;%LIB%"
set "LIBPATH=c:\Utils\icu32_53_1_msvc2010\lib;%LIBPATH_MSVC2010%;%LIBPATH%"
set "INCLUDE=C:\Utils\icu32_53_1_msvc2010\include;%INCLUDE_MSVC2010%;%INCLUDE%"
set "NODE_VS_V=vs2010"
)

echo %cfg%|findstr /i msvc2012-Windows8-x64 >nul:
if %errorlevel%==0 (
set "PATH=c:\work\build\qtsdk\gnuwin32\bin;C:\Utils\icu64_53_1\bin;c:\Utils\icu64_53_1\lib;%PATH_MSVC2012%;%PATH%"
set "LIB=c:\Utils\icu64_53_1\lib;%LIB_MSVC2012%;%LIB%"
set "LIBPATH=c:\Utils\icu64_53_1\lib;%LIBPATH_MSVC2012%;%LIBPATH%"
set "INCLUDE=C:\Utils\icu64_53_1\include;%INCLUDE_MSVC2012%;%INCLUDE%"
set "NODE_VS_V=vs2012"
)

echo %cfg%|findstr /i msvc2012-Windows8-x86 >nul:
if %errorlevel%==0 (
set "PATH=c:\work\build\qtsdk\gnuwin32\bin;C:\Utils\icu32_53_1\bin;c:\Utils\icu32_53_1\lib;%PATH_MSVC2012%;%PATH%"
set "LIB=c:\Utils\icu32_53_1\lib;%LIB_MSVC2012%;%LIB%"
set "LIBPATH=c:\Utils\icu32_53_1\lib;%LIBPATH_MSVC2012%;%LIBPATH%"
set "INCLUDE=C:\Utils\icu32_53_1\include;%INCLUDE_MSVC2012%;%INCLUDE%"
set "NODE_VS_V=vs2012"
)
...
if %errorlevel%==0 (
set "PATH=c:\windows\SysWOW64;c:\work\build\qtsdk\gnuwin32\bin;C:\utils\mysql\mysql\bin;C:\utils\postgresql\pgsql\bin;C:\Python27\;C:\Python27\Scripts;C:\Windows\System32\WindowsPowerShell\v1.0\;C:\Program Files (x86)\Git\cmd;C:\strawberry\c\bin;C:\strawberry\perl\site\bin;C:\strawberry\perl\bin;C:\Program Files\Microsoft SQL Server\110\Tools\Binn\;C:\openssl\bin;C:\Program Files (x86)\Java\jdk7\bin;C:\mingw\mingw\bin;C:\mingw48\mingw32\bin;C:\Utils\icu32_53_1_mingw482\bin;C:\utils\jom;C:\CMake\in;C:\ruby\bin;C:\utils\sevenzip\;C:\utils\squish\squish\bin;C:\utils\squish\;C:\utils\squish\squish;C:\Program Files (x86)\Notepad++;!PATH!"
set "LIB=C:\utils\postgresql\pgsql\lib;C:\utils\mysql\mysql\lib;!LIB!"
set "LIBPATH=C:\utils\postgresql\pgsql\lib;C:\utils\mysql\mysql\lib;!LIBPATH!"
set "INCLUDE=C:\utils\postgresql\pgsql\include;C:\utils\mysql\mysql\include;!INCLUDE!"
call "c:\Program Files (x86)\Microsoft Visual Studio 12.0\vc\vcvarsall.bat" x86
...
if %errorlevel%==0 (
set "PATH=c:\work\build\qtsdk\gnuwin32\bin;%PATH_MINGW48%;C:\Utils\icu32_53_1_mingw482\bin;C:\Utils\icu32_53_1_mingw482\lib;%PATH%;C:\openssl\bin"
set "LIB=C:\mingw48\mingw32\lib;;C:\Utils\icu32_53_1_mingw482\lib;%LIB%;C:\opensll\lib"
set "INCLUDE=%INCLUDE%;C:\mingw48\mingw32\include;C:\Utils\icu32_53_1_mingw482\include;C:\openssl\include"
set QTDIR=
set "NODE_ARCH=32"
)

...
function Component()
{
    ...
    if (installer.value("HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\VisualStudio\\12.0\\VC\\VCRedist\\x86\\Installed") != 1)
...
Component.prototype.createOperations = function()
{
    ...
    if (installer.value("HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\VisualStudio\\12.0\\VC\\VCRedist\\x86\\Installed") != 1) {
        ...
        component.addElevatedOperation("Execute", "{0,3010,1638,5100}", "@TargetDir@\\vcredist\\vcredist_msvc2013_x86.exe", "/norestart", "/q");
    }
}

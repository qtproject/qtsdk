...
function createShortcuts()
{
    ...
    component.addOperation( "CreateShortcut",
                            ...
                            "@StartMenuDir@/" + qtStringVersion + "/Windows Phone (arm) MSVC 2013 (32-bit)/Assistant.lnk");

    // Designer
    component.addOperation( "CreateShortcut",
                            component_root_path + "/bin/designer.exe",
                            "@StartMenuDir@/" + qtStringVersion + "/Windows Phone (arm) MSVC 2013 (32-bit)/Designer.lnk");

    // Linguist
    component.addOperation( "CreateShortcut",
                            component_root_path + "/bin/linguist.exe",
                            "@StartMenuDir@/" + qtStringVersion + "/Windows Phone (arm) MSVC 2013 (32-bit)/Linguist.lnk");

    // qtd3dservice
    component.addOperation( "CreateShortcut",
                            component_root_path + "/bin/qtd3dservice.exe",
                            "@StartMenuDir@/" + qtStringVersion + "/Windows Phone (arm) MSVC 2013 (32-bit)/qtd3dservice.lnk");
}

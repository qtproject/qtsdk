...
function Component()
{
    if ((installer.value("os") == "win")
        ...
        var android_armv7 = installer.componentByName("qt.55.android_armv7");
        var winphone_arm = installer.componentByName("qt.55.win64_msvc2013_winphone_arm");
        var winphone_x86 = installer.componentByName("qt.55.win64_msvc2013_winphone_x86");
        ...
        if (msvc2013) {
            // if 64bit machine
            if (!(installer.environmentVariable("ProgramFiles(x86)") == "")) {
                installer.componentByName("qt.55.win64_msvc2013_64").setValue("Default", "true");
            } else {
                installer.componentByName("qt.55.win32_msvc2013").setValue("Default", "true");
            }
        }

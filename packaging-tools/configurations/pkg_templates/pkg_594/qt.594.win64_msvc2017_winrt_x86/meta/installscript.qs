...
function Component()
{
    ...
    if (snapshotBuild) {
        ...
        var dependencyStr = "preview.qt.59.win64_msvc2017_winrt_x86";
        if (autoDependency) {
...
function createShortcuts()
{
    ...
    component.addOperation( "CreateShortcut",
                            cmdLocation,
                            "@StartMenuDir@/" + qtStringVersion + "/MSVC 2017 (64-bit)/Qt " + qtStringVersion + " 64-bit for Universal Windows Platform 32-bit (MSVC 2017).lnk",
                            "/A /Q /K " + batchFileName);
}

        ...
        if (xcodeVersion) {
            ...
            if (parseInt(version) >= parseInt(400) && parseInt(version) <= parseInt(500)) {
                QMessageBox["warning"]("XcodeVersionError",
                        ...
                        qsTr("It is recommeneded to have Xcode version greater than 4.0.0 and smaller than 5.0.0 for Qt 5.9.4 compilations with clang."));
            }
        }
        else {
            QMessageBox["warning"]("XcodeError",
                qsTr("Xcode installation not found!"),
                qsTr("You need to install Xcode. Download Xcode from https://developer.apple.com/xcode\n"));
        }
    }
...
Component.prototype.createOperations = function()
{
    ...
    try {
        ...
        patchQtExamplesAndDoc(component, installationPath, "Qt-5.9.4");
        ...
        // QTBUG-37650
        patchQtAssistant(component, installationPath, "Qt-5.9.4");

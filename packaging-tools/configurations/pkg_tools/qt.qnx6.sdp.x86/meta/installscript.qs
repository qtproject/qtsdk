...
Component.prototype.createOperations = function()
{
    ...
    component.addOperation("Execute",
                           ["@SDKToolBinary@", "addTC",
                            "--id", "Qnx.QccToolChain:opt_qnx660_qcc_x86",
                            ...
                            "UNDOEXECUTE",
                            "@SDKToolBinary@", "rmTC", "--id", "Qnx.QccToolChain:opt_qnx660_qcc_x86"]);

    // add QCC Debugger (QNX SDP) to QtCreator
    component.addOperation("Execute",
                           ["@SDKToolBinary@", "addDebugger",
                            "--id", "opt_qnx660_debugger_x86",
                            ...
                            "UNDOEXECUTE",
                            "@SDKToolBinary@", "rmDebugger", "--id", "opt_qnx660_debugger_x86"]);
}

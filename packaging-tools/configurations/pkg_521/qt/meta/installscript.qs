...
changeLicenseLabels = function()
{
    ...
    page.AcceptLicenseLabel.setText("I h<u>a</u>ve read and agree to the following terms contained in the license agreements accompanying the Qt 5.2.1 installer and additional items. I agree that my use of the Qt 5.2.1 installer is governed by the terms and conditions contained in these license agreements.");
    page.RejectLicenseLabel.setText("I <u>d</u>o not accept the terms and conditions of the above listed license agreements. Please note by checking the box, you must cancel the installation or downloading the Qt 5.2.1 and must destroy all copies, or portions thereof, of the Qt 5.2.1 in your possessions.");
}
    ...
    if (installer.value("os") == "win") {
        try {
            ...
            component.addOperation( "CreateShortcut",
                                    win_application,
                                    "@StartMenuDir@/Uninstall Qt 5.2.1.lnk",
                                    " --uninstall");
        } catch( e ) {
            print( e );
        }

...
def get_clang(base_path, llvm_revision, clang_revision):
    bld_utils.runCommand(['git', 'clone', 'https://github.com/llvm-mirror/llvm'], base_path)
    bld_utils.runCommand(['git', 'checkout', llvm_revision], os.path.join(base_path, 'llvm'))
    bld_utils.runCommand(['git', 'clone', 'https://github.com/llvm-mirror/clang'], os.path.join(base_path, 'llvm', 'tools'))
